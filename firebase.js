...
function Permission_FCM(firebase){
  ...
  .then((token) => {
    console.log(token);
    // const db = firebase.database().ref().child("notifications");
    // const dbRef = db.child("tokens");
    // dbRef.set({
    //   //authKey: "AAAAyLtf2oQ:APA91bGJzco93OMPccA_lO-03M90Tsin8tl9yEirP3N-D38lbY8IhzusuVsDaR3ZQXORhIKSyK0V2AMXSyVD3uOZU_EgaZ74Vk0fj31VJVRxLgiIB3Fcyxg8-GS6Nx7XZJikw0dzzZWb",
